...
class DataTrainingArguments:
    ...
    only_protein_coding: bool = field(
        default=True,
        metadata={"help": "Whether to include only protein-coding genes when using FASTA+GTF."},
    )
    use_cds_mask: bool = field(
        default=True,
...
def main():
    ...
    if training_args.do_train:
        if use_cds_dataset:
            train_dataset = cds_train_dataset
        else:
